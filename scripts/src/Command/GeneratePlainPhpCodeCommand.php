...
#[AsCommand(name: 'know:generate-plain-php-code')]
class GeneratePlainPhpCodeCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setDescription('Generates a class for a given ontology (WARN: only for local development).')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $phpCode = $this->phpCodeGenerator->generateFileData($urlOrLocalPathToRdfFile, $config);
